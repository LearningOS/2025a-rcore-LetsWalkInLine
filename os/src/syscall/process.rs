...
use crate::task::{
    change_program_brk, current_memoryset_insert_framed_area, current_user_token,
    exit_current_and_run_next, get_syscalls_count, suspend_current_and_run_next,
};
...
pub fn sys_munmap(start: usize, len: usize) -> isize {
    ...
    if crate::task::current_memoryset_unmap_range(start_va, end_va) {
        return 0;
    }
